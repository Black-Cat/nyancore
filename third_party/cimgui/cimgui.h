...
typedef enum {
    ...
    ImGuiDragDropFlags_AcceptDrawLine = 1 << 13,
    ImGuiDragDropFlags_ReorderHorizontal = 1 << 14
}ImGuiDragDropFlags_;
typedef enum {
    ImGuiDataType_S8,
    ImGuiDataType_U8,
...
typedef enum {
    ...
    ImGuiStyleVar_DragDropTargetPadding,
    ImGuiStyleVar_COUNT
}ImGuiStyleVar_;
typedef enum {
...
CIMGUI_API const ImGuiPayload* igAcceptReorderDropPayload(const char* type, ImGuiDragDropFlags flags);
...
// LAMIA_PATCH_START
CIMGUI_API void igDockBuilderSetCentralNoTabBar(ImGuiID dockspace_id);
// LAMIA_PATCH_END
