...
fn hexToColor(col: u24) c.ImVec4 {
    ...
    return .{
        .x = @intToFloat(f16, ch[2]) / 255.0,
        .y = @intToFloat(f16, ch[1]) / 255.0,
        .z = @intToFloat(f16, ch[0]) / 255.0,
        .w = 1.0,
    };
}
...
pub const ToolUI = struct {
    ...
    fn palette(col: c.ImGuiCol_) c.ImVec4 {
        return switch (col) {
            c.ImGuiCol_Text => .{ .x = 1.0, .y = 0.9, .z = 0.9, .w = 1.0 },
            c.ImGuiCol_TextDisabled => mainColors[1],
            c.ImGuiCol_WindowBg => mainColors[1],
            ...
            c.ImGuiCol_Button => mainColors[4],
            c.ImGuiCol_ButtonHovered => mainColors[2],
            c.ImGuiCol_ButtonActive => mainColors[3],
            c.ImGuiCol_Header => mainColors[4],
            c.ImGuiCol_HeaderHovered => mainColors[2],
            c.ImGuiCol_HeaderActive => mainColors[3],
            c.ImGuiCol_Separator => mainColors[4],
            c.ImGuiCol_SeparatorHovered => mainColors[2],
            c.ImGuiCol_SeparatorActive => mainColors[3],
            c.ImGuiCol_ResizeGrip => mainColors[4],
            c.ImGuiCol_ResizeGripHovered => mainColors[2],
            c.ImGuiCol_ResizeGripActive => mainColors[3],
            c.ImGuiCol_Tab => mainColors[4],
            c.ImGuiCol_TabHovered => mainColors[2],
            c.ImGuiCol_TabActive => mainColors[3],
